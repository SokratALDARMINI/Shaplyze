...
class Solve_w_ECOS:
    ...
    def solve(self):
        ...
        # # feastol
        # self.ecos_kwargs["feastol"] = 1e-5
        #
        # # abstol
        # self.ecos_kwargs["abstol"] = 1e-5
        #
        # # reltol
        # self.ecos_kwargs["reltol"] = 1e-4
        #
        # # feastol inacc
        # self.ecos_kwargs["feastol_inacc"] = 1e-3
        #
        # # abstol inacc
        # self.ecos_kwargs["abstol_inacc"] = 1e-4
        #
        # # reltol inacc
        # self.ecos_kwargs["reltol_inacc"] = 1e-4
    ...
    def check_feasibility(self):  # returns pair (p,d) of primal/dual infeasibility (maxima)
        ...
        for i, xyz in enumerate(self.trip_of_idx):
            ...
            # print("i", i, "self.sol_lambda[i]", self.sol_lambda[i], "ln(-self.sol_lambda[i])", ln(-self.sol_lambda[i]))
